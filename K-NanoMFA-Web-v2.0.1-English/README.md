# K-NanoMFA Web v2.0.1 — Dynamic Nanoform-Resolved MFA–Fate Platform
...
Open `K-NanoMFA_User_Manual_v1.2.docx`, `MANUAL_ADDENDUM_v1.3.md`, and `MANUAL_ADDENDUM_v2.0.1.md`, or use the manual links in the application.
